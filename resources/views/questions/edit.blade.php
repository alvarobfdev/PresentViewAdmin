                ...
                <div class="box-body">
                    ...
                    <form id="form" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$question->title}}" name="questionTitle" class="form-control" minlength="10" id="questionTitle" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="datetime" value="{{\Carbon\Carbon::createFromFormat("Y-m-d H:i:s", $question->time_ini)->format("d/m/Y H:i")}}" type="text" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
                            </div>
                            <!-- /.input group -->
                        </div>
                        <!-- /.form group -->
                        ...
                        <div class="form-group">
                            ...
                            <select name="duration" value="{{$question->duration}}" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon">
                                    <input type="checkbox" name="activatePrize" @if($question->prize) checked @endif>
                                </span>
                                <input type="text" value="{{$question->prize_title}}" class="form-control" name="prizeTitle" placeholder="Ej. Iphone 6">
                            </div>
                        </div>
